...
$icons = [
    ...
    'gift' => '<path stroke-linecap="round" stroke-linejoin="round" d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H4.5a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A2.625 2.625 0 1 0 9.375 7.5H12m0-2.625V7.5m0-2.625A2.625 2.625 0 1 1 14.625 7.5H12m0 0V21m-8.25-9.75h16.5a1.125 1.125 0 0 0 1.125-1.125v-1.5a1.125 1.125 0 0 0-1.125-1.125H3.75a1.125 1.125 0 0 0-1.125 1.125v1.5A1.125 1.125 0 0 0 3.75 11.25Z" />',
    ...
    'play' => '<path stroke-linecap="round" stroke-linejoin="round" d="m21 12-14 8V4l14 8Z" />',
    ...
    'inbox' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 9.776c.112-.017.227-.026.344-.026h15.812c.117 0 .232.009.344.026m-16.5 0a2.25 2.25 0 0 0-1.883 2.542l.857 6a2.25 2.25 0 0 0 2.227 1.932H19.05a2.25 2.25 0 0 0 2.227-1.932l.857-6a2.25 2.25 0 0 0-1.883-2.542m-16.5 0V6a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 20.25 6v3.776" />',
    ...
    'cross' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3v18M6 8h12" />',
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.6" stroke="currentColor" {{ $attributes->merge(['class' => $class]) }}>
    {!! $icons[$name] ?? '' !!}
</svg>
